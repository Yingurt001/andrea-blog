...
const SITE_TIMEZONE = 0; //设置你的网站时区 from -12 to 12 default in UTC+8
export const siteConfig: SiteConfig = {
	title: "Andrea's Blog",
	subtitle: "记录生活与研究的小角落",
	siteURL: "https://andrea-blog-gilt.vercel.app/", // 请替换为你的站点URL，以斜杠结尾
	...
	themeColor: {
		hue: 150, // 主题色的默认色相，范围从 0 到 360。例如：红色：0，青色：200，蓝绿色：250，粉色：345
...
export const profileConfig: ProfileConfig = {
	...
	name: "Ying Zhang",
	bio: "MPhil Data Intensive Science @ Cambridge | Hyperbolic DL & Statistical Inference",
	typewriter: {
	...
	links: [
		{
			...
			url: "https://github.com/Yingurt001",
		},
		{
			name: "ORCID",
			icon: "simple-icons:orcid",
			url: "https://orcid.org/0009-0000-2900-9197",
		},
	],
};
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "欢迎来到我的博客！这里记录生活与研究。", // 公告内容
